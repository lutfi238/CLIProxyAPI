...
// Updated based on testing with GitHub Copilot Pro (Dec 2025)
// NOTE: Some models shown in Copilot UI may not be available via API due to staged rollout.
func GetGitHubCopilotModels() []*ModelInfo {
	...
	return []*ModelInfo{
		...
		// Fast and cost-efficient
		{
			...
			Description:         "OpenAI GPT-5 Mini via Copilot - Fast and cost-efficient",
			ContextLength:       128000,
		...
		},
		{
			...
			Description:         "xAI Grok Code Fast 1 via Copilot - Fast and cost-efficient",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		// Versatile and highly intelligent
		{
			...
			Description:         "Anthropic Claude Sonnet 4.5 via Copilot - Versatile and highly intelligent",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-4.1",
			Description:         "OpenAI GPT-4.1 via Copilot - Versatile and highly intelligent",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-4o",
			Description:         "OpenAI GPT-4o via Copilot - Versatile and highly intelligent",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		// Most powerful at complex tasks
		{
			...
			Description:         "Anthropic Claude Opus 4.5 via Copilot (Preview) - Most powerful",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			OwnedBy:             "copilot",
			Type:                "copilot",
			DisplayName:         "GPT-5.1 Codex Max (Agent Only)",
			Description:         "OpenAI GPT-5.1 Codex Max - AGENT MODE ONLY, not accessible via /chat/completions",
			ContextLength:       200000,
